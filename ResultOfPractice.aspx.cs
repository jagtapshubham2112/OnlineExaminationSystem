...
public partial class ResultOfPractice : System.Web.UI.Page
{
    ...
    protected void showResult()
    {
        try
        {
            ...
            Con.ConnectionString = ConString;
            Con.Open();
            String SqlQuery = "SELECT * FROM Practice_Master WHERE Subject_Id = @Subject_Id AND Student_PRN = @Student_PRNNO;";
            SqlCommand Cmd = new SqlCommand();
            Cmd.Connection = Con;
            Cmd.CommandText = SqlQuery;
            Cmd.Parameters.AddWithValue("@Subject_Id", Session["Subject_Id"].ToString());
